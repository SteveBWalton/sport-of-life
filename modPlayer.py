...
class CPlayer:
    ...
    def _GetNames(self, nCulture):
        ...
        if nCulture == 1:
            ...
            # English names.
            FirstNames = ['Steve',  'Fred',  'Stephen', 'Joe', 'Darren', 'Ronnie', 'Mark', 'Alex', 'Shaun', 'Judd', 'Paul', 'Andrew', 'Ray', 'Kyren', 'Neil', 'Barry', 'Stuart', 'Anthony', 'Graeme', 'John', 'Eddie', 'Kirk', 'Cliff', 'Perrie', 'Ricky', 'Jimmy', 'Daniel', 'Tom', 'Nigel', 'Scott', 'Lewis', 'Damon', 'Jim', 'Sebastian', 'Gareth', 'David', 'Michael', 'Robert', 'James', 'Alan', 'Harry', 'Sterling', 'Richard', 'Bjorg', 'Ivan', 'Gary', 'Martin', 'George']
            LastNames =  ['Walton', 'Davis', 'Hendry', 'Johnson', 'Lumby', 'O\'Sullivan', 'Williams', 'Higgins', 'Murphy','Trump','Walker', 'Jackson', 'Reardon', 'Wilson', 'Robertson', 'Hawkins', 'Bingham', 'McGill', 'Dott', 'Spencer', 'Charlton', 'Stevens', 'Thorburn', 'Mans', 'Walden', 'White', 'Wells', 'Ford', 'Bond', 'Donaldson', 'Hamilton', 'Hill', 'Clark', 'Coe',  'Southgate', 'Coulthard', 'Holt', 'Redford', 'Whale', 'McManus', 'Potter', 'Moss', 'Osman', 'Borg', 'Lendl', 'Newman', 'Freeman', 'Peel']
